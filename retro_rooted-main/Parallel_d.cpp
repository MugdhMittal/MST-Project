...
public:
    ...
    void Process_Status(vector<Edge> &CE, vector<EdgeStatus> &Status, vector<Edge> &Marked)
    {
        ...
        // Remove deleted edges from MST and remainder
        ...
        // Check MST integrity: use Repair_Tree instead of full rebuild
        if (Ex.size() < V - 1)
        {
...
int main()
{
    ...
    const std::string filename = "in001.txt";
